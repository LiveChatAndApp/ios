...
- (void)initSearchUIAndData {
    ...
    UIImage* searchBarBg = [UIImage imageWithColor:[UIColor colorWithHexString:@"0xf6f6f6"] size:CGSizeMake(self.view.frame.size.width - 8 * 2, 36) cornerRadius:4];
    ...
    if (@available(iOS 13.0, *)) {
        self.searchController.searchBar.searchTextField.layer.cornerRadius = 13;
