...
#ifdef UAT
NSString *IM_SERVER_HOST = @"18.166.154.97";
#endif
#ifdef DEV
NSString *IM_SERVER_HOST = @"192.168.1.32";
#endif
...
#ifdef UAT
NSString *APP_SERVER_ADDRESS = @"http://18.166.154.97:8888";
#endif
#ifdef DEV
NSString *APP_SERVER_ADDRESS = @"http://192.168.1.32:8888";
#endif
